        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <div class="get">
                    ...
                    // Define the SQL query to fetch the latest 10 donation records
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $row) { ?>
                                        <?php
                                        $status = $row['assigned_to'] ? 'Assigned' : 'Unassigned';
                                        echo "<tr><td data-label=\"name\">" . $row['name'] . "</td><td data-label=\"food\">" . $row['food'] . "</td><td data-label=\"category\">" . $row['category'] . "</td><td data-label=\"phoneno\">" . $row['phoneno'] . "</td><td data-label=\"date\">" . $row['date'] . "</td><td data-label=\"Address\">" . $row['address'] . "</td><td data-label=\"quantity\">" . $row['quantity'] . "</td><td data-label=\"Status\">" . $status . "</td></tr>";
                                        ?>
                                    <?php } ?>
                                </tbody>
                            </table>
