...
if (isset($_POST['sign'])) {
    ...
    if ($num == 1) {
        ...
        $insert_stmt = mysqli_prepare($connection, "INSERT INTO login(name, email, password, gender) VALUES (?, ?, ?, ?)");
        mysqli_stmt_bind_param($insert_stmt, "ssss", $username, $email, $pass, $gender);
